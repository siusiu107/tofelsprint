...
try{
  ...
  async function buildReadingIndex(){
    ...
    if(!root) throw new Error('Reading 데이터가 없어. 예: data/reading/TOEFL_Reading_0002.txt 같은 파일이 있어야 해.');
    ...
    if(!maxId) throw new Error('Reading txt 파일을 못 찾았어. 예: data/reading/TOEFL_Reading_0002.txt');
